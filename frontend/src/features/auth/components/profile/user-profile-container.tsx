...
export function UserProfileContainer({ user }: UserProfileContainerProps) {
  return (
    <div className="min-h-screen bg-muted/40 pb-24 overflow-y-auto max-h-60">
      {/* Header */}
      <div className="bg-linear-to-br from-primary to-orange-600 px-6 pt-8 pb-10 flex flex-col items-center gap-3 text-white">
        {/* Avatar */}
        <div className="w-24 h-24 rounded-full border-4 border-white/50 flex items-center justify-center text-3xl font-bold bg-orange-400">
      ...
      <div className="px-4 -mt-6 flex gap-3">
        <div className="flex-1 bg-white rounded-2xl shadow p-4 text-center">
          ...
          <p className="text-muted-foreground text-sm">แจ้งเหตุทั้งหมด</p>
        </div>
